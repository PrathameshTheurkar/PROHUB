...
const Slogan= () =>{
    return  (
        <div className="Slogan">
            ...
            <div className= "Slogan1"><h1>Student Code</h1></div>
            <div className= "Slogan2"><h1>INNOVATION HUB</h1></div>
            <div className = "Slogan3">“ CODE | COLLABORATE | INNOVATE | TRIUMPH “</div>
            <div className='Description'>
                <p>A platform for Tech enthusiasts to work, explore and collaborate with wizards from multiple domains and  ultimately brush an astonishing touch to their innovation </p>
